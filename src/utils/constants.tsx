export const REACT_APP_API_SERVER_URL: string = import.meta.env.VITE_API_SERVER_URL || 'http://localhost:8080/api'
...
export const REACT_APP_AUTH0_CALLBACK_URL: string = import.meta.env.VITE_AUTH0_CALLBACK_URL || 'http://localhost:5173/callback'
